    ...
    return (
        <>
            <div className="md:flex gap-4 hidden">
                <Link to="/my-profile" className="rounded-md flex items-center px-2 lg:px-5 bg-blue-500 hover:text-blue-500 hover:bg-gray-100 transition outline-none">My Profile</Link>
            ...
            <div className={`${isOpen ? "block" : "hidden"} absolute right-0 h-screen w-2/3 bg-blue-800`}>
                ...
                <div className="mt-14 flex flex-col gap-5 px-3">
                    <Link to="/my-profile" className="border-b-2 pb-1 flex items-center px-2 hover:text-blue-500 transition outline-none">My Profile</Link>
